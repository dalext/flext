...
class OptionsOutput {
  ...
  resp(resp) {
    ...
    resp.setHeader(
      ...
      "Access-Control-Allow-Headers, 0, Origin, Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers"
    );
    resp.end("");
  }
}
...
handle("OPTIONS", ["docs", null, "events"], (id, req, resp) => {
  console.log("OPT");
  return new OptionsOutput(200, "", "text/plain");
});
